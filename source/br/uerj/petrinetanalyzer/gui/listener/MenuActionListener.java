...
import br.uerj.FileFilter.FileFilterUtil;
import br.uerj.FileFilter.FileFilterXML;
...
implements IntfLanguageConstants, IntfMainConstants
{
	...
	/**
	 * Salva o arquivo se ele já existir, ou abre caixa
	 * de diálogo caso ele não exista.
	 *
	 */
	...
	/**
	 * Lê o arquivo em formato XML e o converte para Objeto rede
	 * de Petri.
	 * @throws IOException
